...
# dist/claude-usage-lens-darwin-arm64, `make build` leaves dist/claude-usage-lens.
CLI_BIN ?= $(firstword $(wildcard ../claude-usage-lens/dist/claude-usage-lens-darwin-arm64 ../claude-usage-lens/dist/claude-usage-lens))
...
BREW_KIND := cask
BREW_DESC := Menu-bar app showing today's Claude usage cost with charts
BREW_NAME := $(NAME)
